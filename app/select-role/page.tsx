      ...
      <div className="relative flex items-center justify-center min-h-screen px-4 py-12">
        <div className="w-full max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Client Card */}
            <div className="group">
              <div className="bg-[hsl(0_0%_100%)/0.8] backdrop-blur-sm rounded-xl border border-[hsl(214.3_31.8%_91.4%)] p-8 transition-all duration-300 hover:shadow-[0_10px_30px_-10px_hsl(160_84%_39%/0.3)]  hover:-translate-y-2 hover:border-[hsl(160_84%_39%)/0.3]">
