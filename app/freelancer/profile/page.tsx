...
const FreelancerProfilePage = () => {
  ...
  return (
    <div className="min-h-screen text-black bg-[hsl(0_0%_100%)]  p-6">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <h1 className="text-2xl font-bold text-[hsl(222.2_84%_4.9%)]">
            Freelancer Profile
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 mb-6">
                ...
                <div className="relative">
                  <Avatar className="w-20 h-20 sm:w-24 sm:h-24">
                    ...
                    <AvatarFallback className="bg-[hsl(160_84%_39%/0.2)] text-[hsl(160_84%_39%)] text-xl sm:text-2xl">
                      EW
                    </AvatarFallback>
                  </Avatar>
                ...
                <div className="w-full text-center sm:text-left">
                  <h2 className="text-xl sm:text-2xl font-bold text-[hsl(222.2_84%_4.9%)] mb-1">
                    Eva Watson
                  </h2>
                  <p className="text-[hsl(215.4_16.3%_46.9%)] mb-1">
                    Graphic Designer
                  </p>
                  ...
                  {/* Stats */}
                  <div className="grid grid-cols-3 gap-4 mt-4 max-w-xs mx-auto sm:mx-0">
            ...
            <div className="bg-card rounded-lg border border-[hsl(214.3_31.8%_91.4%)]  p-6">
              ...
              <p className="text-[hsl(215.4_16.3%_46.9%)]  leading-relaxed mb-4">
                Join our interactive AI Workshop designed exclusively for
                freelancers! Learn how to integrate cutting-edge AI tools into
                your workflow to boost productivity, streamline client
                communication, and stay ahead in the freelance market. Whether
                you&apos;re a designer, writer, developer, or marketer—this
                session will give you hands-on strategies to elevate your game
                using AI.
              </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg border border-[hsl(214.3_31.8%_91.4%)]  p-6 text-center">
              <div className="text-3xl font-bold text-[hsl(222.2_84%_4.9%)]  mb-2">
                $150
              </div>
