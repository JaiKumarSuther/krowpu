        ...
        <div className="flex-1 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`
                  ...
                  ${budgetType === "hourly" 
                    ...
                    : 'border-border bg-card hover:border-primary/30 hover:bg-[hsl(0_0%_96%)]'
                  }
                `}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-foreground">Hourly rate</h3>
                    <p className="text-xs text-muted-foreground">Pay by the hour</p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-foreground">Fixed price</h3>
                    <p className="text-xs text-muted-foreground">Pay a set amount</p>
                  </div>
                </div>
              </button>
            </div>
          ...
          {budgetType === "hourly" ? (
            <div className="space-y-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="12"
                      className="w-full bg-input border border-input-border rounded-lg pl-8 pr-12 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[hsl(160_84%_39%)] focus:border-transparent transition-all duration-200"
                    />
              ...
              {hourlyFrom && hourlyTo && (
                <div className="bg-[hsl(160_60%_95%)] rounded-lg p-4 border border-[hsl(160_84%_39%)/0.1]">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="5,000"
                  className="w-full bg-input border border-input-border rounded-lg pl-8 pr-4 py-4 text-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[hsl(160_84%_39%)] focus:border-transparent transition-all duration-200"
                />
              </div>
          ...
          {/* Budget Tips */}
          <div className="bg-[hsl(0_0%_96%)] rounded-lg p-4 border border-[hsl(0_0%_80%)]">
