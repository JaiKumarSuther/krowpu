      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 space-y-4">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-medium text-[hsl(220_9%_46%)] tracking-wider uppercase">
              Event Post
            </span>
          </div>

          <h2 className="text-3xl lg:text-4xl font-bold text-[hsl(220_13%_13%)] leading-tight">
            What are the main
            <span className="text-[hsl(160_84%_39%)] block lg:inline lg:ml-2">skills required?</span>
          </h2>

          <p className="text-lg text-[hsl(220_9%_46%)] leading-relaxed">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="space-y-3">
            <label className="text-sm font-medium text-[hsl(220_13%_13%)] block">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[hsl(220_14%_96%)] border border-[hsl(220_14%_87%)] rounded-lg px-4 py-4 text-[hsl(220_13%_13%)] placeholder:text-[hsl(220_9%_46%)] focus:outline-none focus:ring-2 focus:ring-[hsl(160_84%_39%)] focus:border-transparent transition-all duration-200"
              />
              <div className="absolute right-3 top-1/2 -translate-y-1/2">
                <svg className="w-5 h-5 text-[hsl(220_9%_46%)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedSkills.map(skill => (
                  <button
                    ...
                    className="inline-flex items-center gap-2 bg-[hsl(160_84%_39%)] text-[hsl(0_0%_100%)] rounded-full px-4 py-2 text-sm font-medium hover:bg-[hsl(160_84%_35%)] transition-all duration-200 shadow-sm"
                  >
                    {skill}
          ...
          {searchTerm && !allSkills.some(skill => skill.toLowerCase() === searchTerm.toLowerCase()) && selectedSkills.length < 5 && (
            <div className="p-4 bg-[hsl(160_60%_95%)] rounded-lg border border-[hsl(160_84%_39%)/0.2]">
              <p className="text-sm text-[hsl(220_13%_13%)] mb-2">Add custom skill:</p>
              <button
                onClick={() => {
                  toggleSkill(searchTerm);
                  setSearchTerm("");
                }}
                className="inline-flex items-center gap-2 bg-[hsl(160_84%_39%)] text-[hsl(0_0%_100%)] rounded-full px-4 py-2 text-sm font-medium hover:bg-[hsl(160_84%_35%)] transition-all duration-200"
              >
                Add &quot;{searchTerm}&quot;
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
