      ...
      <div className="w-full max-w-[480px] bg-[hsl(0_0%_100%)/0.8] backdrop-blur-sm rounded-xl shadow-[0_10px_30px_-10px_hsl(160_84%_39%/0.3)]  p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            />
            {errors.email && (
              <p className="text-[hsl(0_84.2%_60.2%)] text-xs mt-1">{errors.email}</p>
            )}
          </div>
          ...
          <div className="relative">
            ...
            {errors.password && (
              <p className="text-[hsl(0_84.2%_60.2%)] text-xs mt-1">{errors.password}</p>
            )}
          </div>
        ...
        <p className="mt-6 text-sm text-[hsl(215.4_16.3%_46.9%)] text-center">
          ...
          <Link href="/select-role" className="text-[hsl(160_84%_39%)] font-medium hover:underline">
            Sign up
          </Link>
        </p>
      </div>
